 <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="<?php echo base_url('excel/format.xlsx')?>"> > > Unduh Format File< < </a> 
                                    <form method="POST" action="<?php echo base_url('dosen/mhsupload')?>" enctype="multipart/form-data">
                                        <div class="row">
    ...
    if(isset($_POST['preview'])){ 
        if(isset($upload_error)){ 
            redirect(base_url('dosen/mhsupload'));
           // echo "<div style='color: red;'>Anda belum memilih file untuk di unggah!</div>"; 
            die; 
        }
        
        echo "<form method='post' action='".base_url("dosen/mhsimport")."'>";
        ...
        <?php
            echo "<a href='".base_url('dosen/mhsupload')."' class='btn btn-warning btn-fill'>Kembali</a>";
